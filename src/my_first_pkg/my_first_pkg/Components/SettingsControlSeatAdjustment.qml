    ...
    contentItem: ColumnLayout {
        ...
        RowLayout {
            ...
            SwipeView {
                ...
                SeatIcon {
                    source: "../icons/seatIcons/mdi--car-seat.svg"
                }

                SeatIcon {
                    source: "../icons/seatIcons/mdi--car-seat-heater.svg"
                }

                SeatIcon {
                    source: "../icons/seatIcons/mdi--car-seat-cooler.svg"
                }


                SeatIcon {
                    source: "../icons/seatIcons/mdi--seat-recline-extra.svg"
                }

                SeatIcon {
                    source: "../icons/seatIcons/mdi--seat-passenger.svg"
                }

                SeatIcon {
                    source: "../icons/seatIcons/mdi--seat-legroom-normal.svg"
                }


                SeatIcon {
                    source: "../icons/seatIcons/mdi--seat-legroom-extra.svg"
                }

                SeatIcon {
                    source: "../icons/seatIcons/mdi--seat-individual-suite.svg"
                }

                SeatIcon {
                    source: "../icons/seatIcons/mdi--seat-flat-angled.svg"
                }
            }
