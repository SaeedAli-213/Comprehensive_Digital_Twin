    ...
    ColumnLayout {
            ...
            Image {
                ...
                source: {
                    if(musicStationConnected == 0){
                        return "../icons/icon_battrey/Bluetooth Icon.svg"
                    }else if(musicStationConnected == 1){
                        return "../icons/icon_battrey/Wifi-icon.svg"
                    }else {
                        return "../icons/icon_battrey/logos--spotify-icon.svg"
                    }
                }
            }
        }
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                PrefsButton {
                    Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    setIcon: "../icons/icon_battrey/music-backword.svg"
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Image {
                            ...
                            Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                            source: "../icons/icon_battrey/FMStation.svg"
                        }
                ...
                PrefsButton {
                    Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    setIcon: "../icons/icon_battrey/Skip Track Button.svg"
                    backgroundColor: "#00000000"
                    onClicked: {
        ...
        RowLayout {
            ...
            Image {
                Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                source: "../icons/music-dummy-icons/Song 6.png"
            }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    PrefsButton {
                        ...
                        setIcon: playing ? "../icons/icon_battrey/mage--play-fill.svg" : "../icons/icon_battrey/mage--pause-fill.svg"
                        Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    }
                    PrefsButton {
                        Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
