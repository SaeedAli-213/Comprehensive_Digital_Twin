...
Rectangle {
    ...
    ListModel {
        ...
        ListElement {
            title : "Smooth"
            actor: "Connor Price"
            icon: "../icons/music-dummy-icons/Song 1.png"
        }
        ListElement {
            title : "Smooth"
            actor: "Connor Price"
            icon: "../icons/music-dummy-icons/Song 2.png"
        }
        ListElement {
            title : "Smooth"
            actor: "Connor Price"
            icon: "../icons/music-dummy-icons/Song 3.png"
        }
        ListElement {
            title : "Smooth"
            actor: "Connor Price"
            icon: "../icons/music-dummy-icons/Song 4.png"
        }
        ListElement {
            title : "Smooth"
            actor: "Connor Price"
            icon: "../icons/music-dummy-icons/Song 5.png"
        }
    }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            PrefsButton {
                ...
                setIcon: "../icons/icon_battrey/icons/Plus-icon-add.svg"
            }
        }
