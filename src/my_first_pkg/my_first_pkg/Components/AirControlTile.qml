    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            PrefsButton {
                ...
                setIcon: "../icons/icon_battrey/Air Up.svg"
                checkable: true
            ...
            PrefsButton {
                Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                backgroundColor: "#00000000"
                setIcon: "../icons/icon_battrey/Air Down.svg"
                checkable: true
                iconColor: checked ? "#FFFFFF" : "#808080"
            }
            PrefsButton {
                Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                backgroundColor: "#00000000"
                setIcon: "../icons/icon_battrey/Down.svg"
                checkable: true
                iconColor: checked ? "#FFFFFF" : "#808080"
            }
        }
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                PrefsButton {
                    ...
                    Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    backgroundColor: "#00000000"
                    setIcon: "../icons/icon_battrey/Air Windshield.svg"
                    checkable: true
                    checked: !airWindow
                    iconColor: checked ? "#FFFFFF" : "#808080"
                    onClicked:  {
            ...
            ColumnLayout {
                ...
                PrefsButton {
                    ...
                    Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    backgroundColor: "#00000000"
                    setIcon: "../icons/icon_battrey/Air Back Window.svg"
                    checkable: true
                    checked: airWindow
                    iconColor: checked ? "#FFFFFF" : "#808080"
                    onClicked:  {
        ...
        RowLayout {
            ...
            RowLayout {
                ...
                Image {
                    Layout.alignment: Qt.AlignHCenter | Qt.AlignVCenter
                    source: "../icons/icon_battrey/Fan Icon.svg"
                }
